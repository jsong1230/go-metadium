...
var (
	...
	NetworkIdFlag = &cli.Uint64Flag{
		Name:     "networkid",
		Usage:    "Explicitly set network id (integer, 11=MetadiumMainnet, 12=MetadiumTestnet)(For testnets: use --metadium-testnet, --goerli, --sepolia, --holesky instead)",
	...
	OverrideCamellia = &cli.Uint64Flag{
		Name:     "override.camellia",
		Usage:    "Manually specify the Camellia fork block number, overriding the bundled setting",
		Category: flags.EthCategory,
	}
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	...
	if ctx.IsSet(BootnodesFlag.Name) {
		...
		case ctx.Bool(HoleskyFlag.Name):
			urls = []string{} // Holesky not supported in Metadium
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	CheckExclusive(ctx, MainnetFlag, MetaTestnetFlag, DeveloperFlag, GoerliFlag, SepoliaFlag, HoleskyFlag)
