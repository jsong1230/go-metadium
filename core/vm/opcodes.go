...
const (
	...
	BASEFEE     OpCode = 0x48
	BLOBHASH    OpCode = 0x49 // EIP-4844: blob hash
	BLOBBASEFEE OpCode = 0x4A // EIP-4844: blob basefee
)
...
const (
	...
	MCOPY    OpCode = 0x5e // EIP-5656: memory copy
	PUSH0    OpCode = 0x5f // EIP-3855: push zero
)
